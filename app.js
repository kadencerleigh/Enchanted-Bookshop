...
async function findSeriesLineup(name,authorHint){
 ...
 if(!name)return;
 el("#modalBody").innerHTML='<div class="eyebrow">🔎 V4.27.9 • SERIES DISCOVERY 3.0</div><h1 class="title">Finding '+esc(name)+'</h1><div class="empty">🔮 Searching by series name'+(authorHint?' and '+esc(authorHint):', known author')+', then comparing public series metadata…</div>';el("#modal").classList.remove("hidden");
 ...
 var discoveryDiag={google:0,olStructured:0,olStructuredLoose:0,olSeriesQuery:0,olAuthorCatalog:0,olSeriesQueryRaw:[],olSeriesQueryAccepted:[]};
 ...
 var diagBox='<details class="series-discovery-diag"><summary>🔧 Discovery diagnostics</summary><div class="tiny">Google candidates: '+discoveryDiag.google+'<br>Open Library series match: '+discoveryDiag.olStructured+'<br>Open Library loose series match: '+discoveryDiag.olStructuredLoose+'<br>Open Library series query: '+discoveryDiag.olSeriesQuery+'<br>Open Library author catalog: '+discoveryDiag.olAuthorCatalog+'<hr><b>Raw exact-series results</b><br>'+rawDiag+'<hr><b>Accepted from exact-series query</b><br>'+acceptedDiag+'</div></details>';
